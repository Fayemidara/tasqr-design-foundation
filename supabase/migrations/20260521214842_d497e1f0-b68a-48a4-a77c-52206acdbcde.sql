...
BEGIN
  ...
  -- Spec violation (malformed count) deductions
  ...
  -- Auto-pause live agents if score is critically low
  IF _score < 50 THEN
...
GRANT EXECUTE ON FUNCTION public.calculate_reliability_score(uuid) TO authenticated;
